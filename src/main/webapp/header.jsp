...
<div class="bottom">
    ...
    <a href="${pageContext.request.contextPath}/user/home" style="text-decoration: none; color: inherit;">
        <div class="tab">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="7" viewBox="0 0 12 7" fill="none">
                <path d="M1.33268 1.16675L5.99935 5.83341L10.666 1.16675" stroke="#00B307" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
    </a>
    ...
    <% if (roleId == 1) { %>
        ...
        <!-- Thêm tab "Đơn hàng" -->
        <a href="${pageContext.request.contextPath}/secured/user/pending-orders" style="text-decoration: none; color: inherit;">
            <div class="tab">
                <p>Đơn hàng</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="7" viewBox="0 0 12 7" fill="none">
                    <path d="M1.33268 1.16675L5.99935 5.83341L10.666 1.16675" stroke="#00B307" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
