                ...
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            switch (status) {
                                case "NOT_CONFIRMED": displayStatus = "Chờ Xác Nhận"; break;
                    ...
                    <td><a href="${pageContext.request.contextPath}/user/detail-order.jsp?orderId=${requestScope.orderId}" class="text-success fw-semibold">Xem chi tiết</a></td>
                </tr>
                <%
                        }
                    } else {
